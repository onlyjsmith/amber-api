...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber Api web application."
  #
  #
  ...
  #
  # settings.secret_key_base= S8bgfj5KnHreFdnv5vMo3F2e2tPZ63VrBpYqNj0ySxs
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amber-api.log", "w"))
  #
  #
end
